				...
				else
				{
					...
					else
					{
						...
						if (namesim!=-0.5)
						{
							...
							else if ((firstname_left.length()==1||firstname_right.length()==1)&&(Similarity2.doAbbrvMatch(fullname_left, fullname_right)))
							{
							...
							else if ((lastname_left.length()==1||lastname_right.length()==1)&&(Similarity2.doAbbrvMatch(fullname_left, fullname_right)))
							{
								if (firstname_left.equals(firstname_right))
								{
									namesim=0.85;//Yash
